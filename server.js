...
// Раздаём статические файлы из папки Desktop (где лежит game.html)
app.use(express.static('C:/Users/Антон/OneDrive/Desktop'));
...
server.listen(8082, () => {
    console.log('Сервер запущен на http://localhost:8082');
    console.log('Откройте в браузере: http://localhost:8082/game.html');
});